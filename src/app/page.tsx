...
export default function Home() {
  ...
  const heroProps = {
    title: 'Achieve Global Recognition by learning specialized skills',
    highlightText: ['Global Recognition'],
    highlightColor: '#f15b29',
    subtitle: 'Get CMA USA certified with Triple i Commerce Academy',
    ctaWhatsApp: {
      text: 'WhatsApp Now',
