...
export default function StudySectionCaFoundation() {
  return (
    <section className="mx-auto bg-white py-10">
      <div className="container mx-auto max-w-5xl px-4 py-8 text-center">
        ...
        <p className="mt-6 font-inter text-lg leading-relaxed text-gray-600 md:text-lg xl:text-xl">
          For 10th-pass-out students considering CA Foundation courses, the choice between offline (classroom-based) and online learning depends on several factors, including learning style, accessibility, and personal preferences.
        </p>
      </div>
