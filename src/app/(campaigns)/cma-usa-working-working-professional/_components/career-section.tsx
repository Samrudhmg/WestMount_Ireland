    ...
    <section className="mx-auto bg-white">
      <div className="container mx-auto max-w-5xl px-4 py-8 text-center">
        <h2 className="text-xl font-bold leading-tight md:text-5xl">
          Achieve Your Next
          {' '}
          <span className="text-iii-accent">Career Milestone</span>
        </h2>
      ...
      <div className="mx-auto flex flex-col md:max-w-6xl md:flex-row">
        ...
        <div className="flex flex-col-reverse items-center justify-center gap-6 p-4 md:w-1/2">
          ...
          <SlideInDiv>
            <Image src="/images/certificate.png" className="motion-translate-x-in-[0%] motion-translate-y-in-[101%]" alt="CMA USA Certificate" title="CMA USA Certificate" width={1200} height={1200} />
          </SlideInDiv>
        </div>
      </div>
